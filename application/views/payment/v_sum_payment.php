						...
						<div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-heading">
								...
								<!-- <div class="pull-right">
									<div class="col-sm-5">
										<select class="form-control inline-block" id="generate_persiode" name="generate_periode">
										</select>
									</div>
									<div class="col-sm-7">
								...
								<div class="col-sm-3">
									<button class="btn btn-success btn-block btn-rounded btn-outline  btn-success">Tampilkan</button>
								</div>
