...
<head>
	...
	<title>Magilla I Fast build Admin dashboard for any platform</title>
				...
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.html">
							...
							<span class="brand-text">ILCS</span>
						</a>
					</div>
				</div>	
			...
			<div id="mobile_only_nav" class="mobile-only-nav pull-right">
				<ul class="nav navbar-right top-nav pull-right">
					<li class="dropdown app-drp">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Muhammad Ferial Fahlevi</a>
					</li>
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="dashboard_dr" class="collapse collapse-level-1">
						<li>
							<a class="active-page" href="#">Opportunity</a>
						</li>
					</ul>
				</li>
				<li>
